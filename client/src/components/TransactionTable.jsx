...
export default function TransactionTable() {
    ...
    return (
        <>
            ...
            <div className="sm:hidden space-y-2">
                {sortedTransactions.map((tx) => {
                    ...
                    return (
                        <div
                            key={tx.id}
                            className="bg-white rounded-2xl border border-gray-200/60 shadow-sm px-4 py-3.5"
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between gap-2 mb-2.5">
                                <div className="flex-1 min-w-0">
                                    <input
                                        ...
                                        className="font-semibold text-gray-900 text-sm bg-transparent outline-none w-full focus:bg-gray-100 rounded px-1 py-0.5 -mx-1"
                                    />
                                    <input
                                        type="date"
                                        value={tx.date}
                                        onChange={(e) => updateTransaction(tx.id, { date: e.target.value })}
                                        className="text-xs text-gray-400 bg-transparent outline-none focus:bg-gray-100 rounded px-1 py-0.5 -mx-1 mt-0.5"
                                    />
                                </div>
                                <p className="text-base font-semibold text-gray-900 tabular-nums shrink-0">
                            ...
                            <div className="flex items-center gap-2 mb-2.5">
                                            ...
                                            onClick={() => {
                                                ...
                                                updateTransaction(tx.id, {
                                                    ...
                                                    exclude_from_report: alwaysExcludedCategories.includes(defaultCat)
                                                        ? !incomeCategories.includes(defaultCat)
                                                        : tx.exclude_from_report
                                                });
                                            }}
                                            className={`text-xs font-medium px-2 py-1 transition-colors whitespace-nowrap ${
                                                tx.type === type
                                                    ? type === "Income" ? "bg-green-500 text-white" : "bg-rose-500 text-white"
                                ...
                                <select
                                    ...
                                    className={`flex-1 text-xs bg-gray-50 rounded-lg px-2 py-1 outline-none cursor-pointer ${isMandatoryExclude ? "text-blue-500" : "text-gray-600"}`}
                                >
                            ...
                            {/* Notes */}
                            {notesOpen && (
                                <div className="mb-2.5 flex items-center gap-2 bg-blue-50/60 rounded-xl px-3 py-2">
                                    ...
                                    <input
                                        ...
                                        className="flex-1 text-sm text-gray-700 bg-white border border-blue-100 rounded-lg px-3 py-1.5 outline-none focus:border-blue-300 placeholder:text-gray-300"
                                        onKeyDown={(e) => { if (e.key === 'Enter' || e.key === 'Escape') toggleNotes(tx.id); }}
                                    />
                                    <button onClick={() => toggleNotes(tx.id)} className="text-xs text-blue-400 shrink-0">Done</button>
                                </div>
                            )}

                            {/* Actions */}
                            <div className="flex items-center gap-1.5 pt-1 border-t border-gray-100">
                                <button onClick={() => handleSplit(tx)}
                                ...
                                <button
                                    ...
                                    className={`p-1.5 rounded-lg transition-colors ${hasNotes || notesOpen ? 'text-blue-400 bg-blue-50' : 'text-gray-300 hover:text-gray-500 hover:bg-gray-100'}`}
                                    title="Note"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-3.5 h-3.5">
                                ...
                                <button
                                    ...
                                    className={`p-1.5 rounded-lg transition-colors ${
                                        isMandatoryExclude ? "text-blue-400 bg-blue-50 cursor-default"
                                        : isExcluded ? "text-gray-500 bg-gray-200" : "text-gray-300 hover:text-gray-500 hover:bg-gray-100"
                                    }`}
                                >
                                    <ExcludeIcon />
                                </button>
            ...
            <div className="hidden sm:block w-full overflow-x-auto bg-white rounded-2xl border border-gray-200/60 shadow-sm">
